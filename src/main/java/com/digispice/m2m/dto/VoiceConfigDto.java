...
public class VoiceConfigDto implements Serializable  {
	...
	private String prov_msisdn_voice;
	private String prov_msisdn_voice_new;
	private int prov_flag;
   
	public String getProv_msisdn_voice() {
		return prov_msisdn_voice;
	}

	public void setProv_msisdn_voice(String prov_msisdn_voice) {
		this.prov_msisdn_voice = prov_msisdn_voice;
	}

	public VoiceConfigDto() {
        super();
    }
	...
	public String getProv_msisdn_voice_new() {
		return prov_msisdn_voice_new;
	}

	public void setProv_msisdn_voice_new(String prov_msisdn_voice_new) {
		this.prov_msisdn_voice_new = prov_msisdn_voice_new;
	}
